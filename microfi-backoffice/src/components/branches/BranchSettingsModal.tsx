...
// ADMIN or that branch's own BRANCH_MANAGER — the same three settings a branch controls about
// itself day to day: when it's open, how a field agent reaches it (e.g. "Contact Branch" in the
// mobile app), and how many cashiers it can hold.
export function BranchSettingsModal({
  ...
  return (
    <>
      ...
      <Modal open={open} onClose={() => setOpen(false)} title={`${branchName} — Branch Settings`}>
