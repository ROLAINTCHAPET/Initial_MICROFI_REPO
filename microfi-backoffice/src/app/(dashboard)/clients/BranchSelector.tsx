...
export function BranchSelector({ branches, selectedBranchId }: { branches: BranchResponse[]; selectedBranchId: string }) {
  const router = useRouter();
  return (
    <select
      value={selectedBranchId}
      onChange={(e) => router.push(`/clients?branchId=${e.target.value}`)}
