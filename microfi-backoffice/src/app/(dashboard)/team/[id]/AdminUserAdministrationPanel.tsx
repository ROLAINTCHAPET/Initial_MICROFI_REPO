...
export async function AdminUserAdministrationPanel({ user, canDelete, isAdmin }: { user: AdminUserResponse; canDelete: boolean; isAdmin: boolean }) {
  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <AdminUserStatusButton userId={user.id} status={user.status} isAdmin={isAdmin} />
